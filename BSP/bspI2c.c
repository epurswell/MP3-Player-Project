/*
  ...
  FEB-2017 Elizabeth Purswell filled in the TODOs
*/
...
void I2C1_init(void){
  ...
  RCC_APB1PeriphClockCmd(RCC_APB1Periph_I2C1, ENABLE);      // EJP
  // enable clock for SCL and SDA pins
  RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOB, ENABLE); 	// EJP
  ...
  */
  ...
  GPIO_InitStruct.GPIO_Pin = GPIO_Pin_8 | GPIO_Pin_9;     //EJP         
  GPIO_InitStruct.GPIO_Mode = GPIO_Mode_AF;  //EJP
  GPIO_InitStruct.GPIO_Speed = GPIO_Speed_50MHz;  //EJP  // note GPIO_Speed_50MHz is now GPIO_Fast_Speed
  GPIO_InitStruct.GPIO_OType = GPIO_OType_OD;  //EJP
  GPIO_InitStruct.GPIO_PuPd = GPIO_PuPd_UP;   //EJP
  GPIO_Init(GPIOB, &GPIO_InitStruct); //EJP
  
  // Connect I2C1 pins to AF:
  // Call GPIO_PinAFConfig once to set up pin 8 (SCL), once to set up pin 9 (SDA)
  GPIO_PinAFConfig(GPIOB, GPIO_PinSource8, GPIO_AF_I2C1);  // EJP
  GPIO_PinAFConfig(GPIOB, GPIO_PinSource9, GPIO_AF_I2C1);       // EJP
  ...
  I2C_InitStruct.I2C_ClockSpeed =   100000;//EJP
  I2C_InitStruct.I2C_Mode = I2C_Mode_I2C; //EJP
  I2C_InitStruct.I2C_DutyCycle = I2C_DutyCycle_2; //EJP
  I2C_InitStruct.I2C_OwnAddress1 = 0x0u;  //EJP
  I2C_InitStruct.I2C_Ack = I2C_Ack_Disable; //EJP
  I2C_InitStruct.I2C_AcknowledgedAddress = I2C_AcknowledgedAddress_7bit; //EJP
  I2C_Init(I2C1, &I2C_InitStruct); //EJP
  
  
  // enable I2C1
  // Call I2C_Cmd() to enable I2C1
  I2C_Cmd(I2C1, ENABLE); //EJP
}
