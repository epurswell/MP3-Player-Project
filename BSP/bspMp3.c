...
const INT8U BspMp3Cancel[] =  { 0x02, 0x00, 0x00, 0x08 };
const INT8U BspMp3ReadDecodeTime[] = { 0x03, 0x04, 0x00, 0x00 }; // 0x03 for read, 0x04 register for SCI_DECODE_TIME
...
const INT8U BspMp3CancelLen = sizeof(BspMp3Cancel);
